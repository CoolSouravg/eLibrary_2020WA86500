<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="eLibrary.adminpublishermanagement" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img width="100px" src="imgs/publisher.png" alt="Publisher Image" />
                    </div>

                    <hr>
                    <br />
                    <div class="form-group row">
                        <label for="TextBox1" class="col-md-4 col-form-label">Publisher ID</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <label for="TextBox2" class="col-md-4 col-form-label">Publisher Name</label>
                        <div class="col-md-8">
